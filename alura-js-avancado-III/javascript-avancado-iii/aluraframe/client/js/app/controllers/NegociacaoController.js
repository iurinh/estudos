...
System.register(['../models/ListaNegociacoes', '../models/Mensagem', '../models/Negociacao', '../views/MensagemView', '../views/NegociacoesView', '../services/NegociacaoService', '../helpers/DateHelper', '../helpers/Bind'], function (_export, _context) {
    ...
    var ListaNegociacoes, Mensagem, Negociacao, MensagemView, NegociacoesView, NegociacaoService, DateHelper, Bind, _createClass, NegociacaoController;
                    ...
                    value: function importaNegociacoes() {
                        ...
                        this._service.importa(this._listaNegociacoes.negociacoes).then(function (negociacoes) {
                            return negociacoes.forEach(function (negociacao) {
                                ...
                                _this3._mensagem.texto = 'Negociaçoes importadas com sucesso.';
                            });
                        }).catch(function (erro) {
